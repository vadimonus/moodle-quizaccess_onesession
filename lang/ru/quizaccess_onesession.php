...
$string['ua_check'] = 'проверить пользовательский агент';
$string['ua_check_desc'] = 'Отключение этого параметра приведет к менее строгим проверкам, но будет совместимо с инструментами прокторинга, такими как Respondus LockDown Browser.';
