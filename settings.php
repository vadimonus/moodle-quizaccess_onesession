...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtextarea('quizaccess_onesession/whitelist',
        get_string('whitelist', 'quizaccess_onesession'), get_string('whitelist_desc', 'quizaccess_onesession'),
        '', PARAM_TEXT));
}
